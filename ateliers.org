...
** 16 septembre : Date libre pour un atelier BlueHats
   ...
   :END:
** 2 septembre : Date libre pour un atelier BlueHats
...
** 8 juillet : Date libre pour un atelier BlueHats
   ...
   Présentation de l'outil [Keycloakify](https://keycloakify.dev) qui permet de personnaliser les pages de login et register de Keycloak.
   ...
   Intervenant: [Joseph Garrone](https://github.com/garronej)
