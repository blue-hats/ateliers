...
** 14 octobre : Date libre pour un atelier BlueHats
   ...
   :END:
** 30 septembre : Présentation de LocoKit, un outil libre Low-code, avec le
projet CaPel du Parc national de Port-Cros
...
Quelles outils et méthodes pour parvenir à ce que votre projet libre
